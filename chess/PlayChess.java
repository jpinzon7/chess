...
public class PlayChess {
	...
	static void printBoard(ArrayList<ReturnPiece> pieces) { // Prints the board and pieces
	...
	static String[][] makeBlankBoard() { // Makes the blanks of the board
	...
	static void printPiecesOnBoard( // Helper function for printBoard
